    ...
    private void initComponents() {
        ...
        mntmLoad.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                String curdir = System.getProperty("user.dir");	//실행하고 있는 현재 위치를 curdir에 저장
                chooser.setCurrentDirectory(new File(curdir));	//선택한 폴더의 디렉토리를 반환
                
                FileNameExtensionFilter filter = new FileNameExtensionFilter("백업 파일", "data");	// (설명,확장자명)
                chooser.setFileFilter(filter);
//            	chooser.setFileFilter(new FileNameExtensionFilter("백업 파일",	"data"));
